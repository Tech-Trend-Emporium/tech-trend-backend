...
namespace Domain.Validations
{
    public static class AuthValidator
    {
        ...
        public const string RefreshTokenRequiredMessage = "The refresh token is required.";
        public const string RefreshTokenLengthMessage = "The refresh token must be between 20 and 500 characters.";
        ...
        public const string EmailOrUsernameRequiredMessage = "The email or username is required.";
        public const string EmailOrUsernameLengthMessage = "The email or username must be between 3 and 150 characters.";
        public const string EmailOrUsernameRegexMessage = "The email or username contains invalid characters.";
