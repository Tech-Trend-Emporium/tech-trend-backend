...
namespace Application.Services
{
    public interface IProductService
    {
        ...
        Task<UpdateProductResponse> UpdateAsync(int id, UpdateProductRequest dto, CancellationToken ct = default);
        Task<DeleteProductResponse> DeleteAsync(int id, CancellationToken ct = default);
